...
export default function SystemPermissionManagement() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-gray-50/50 p-6">
      <div className="mb-6 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-gray-900 tracking-tight">权限管理</h2>
            <p className="text-sm text-gray-500 mt-1">管理系统菜单访问权限及底层数据隔离权限</p>
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div className="p-4 border border-gray-200 rounded-xl">
                <div className="flex items-center justify-between mb-3">
                   <h4 className="font-bold text-gray-800 text-sm">角色: 业务审计员</h4>
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-gray-100">
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="p-3 text-blue-600 hover:underline cursor-pointer">编辑</td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="p-3 pl-8">↳ 权限管理</td>
                    <td className="p-3 text-gray-500">/system/permission</td>
                    <td className="p-3"><span className="px-2 py-1 bg-purple-50 text-purple-600 text-xs rounded">菜单</span></td>
                    <td className="p-3"><span className="text-green-600">显示</span></td>
                    <td className="p-3 text-blue-600 hover:underline cursor-pointer">编辑</td>
                  </tr>
                </tbody>
